...
class QuranMirrorApp(App):
    ...
    def on_start(self):
        ...
        try:
            ...
            # فقط وقتی Pango فعال نشده پیام می‌دهیم؛ اگر درست شده باشد هیچ پیامی نمی‌آید (یعنی حل شده)
            if not _is_pango:
                try:
                    import importlib
                ...
                Clock.schedule_once(lambda *a: toast(_msg, 'تشخیصِ موتورِ متن', kind='warn'), 1.4)
        except Exception:
            pass
