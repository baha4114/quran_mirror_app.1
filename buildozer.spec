...
android.numeric_version = 4010000

# pango: ارائه‌دهندهٔ متنِ Kivy برای شکل‌دهیِ بومیِ عربی/فارسی (اتصالِ حروف + راست‌به‌چپ + ویرایشِ درست)
requirements = python3,kivy==2.3.0,arabic_reshaper,python-bidi==0.4.2,pyjnius,plyer,pypdf,pango
