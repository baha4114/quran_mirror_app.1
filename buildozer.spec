...
source.dir = .
source.include_exts = py,csv,json,ttf,otf,jpg,jpeg,png,mp3,mp4,m4a,pdf,txt
...
requirements = python3,kivy==2.3.0,arabic_reshaper,python-bidi==0.4.2,pyjnius,plyer,pypdf,ffpyplayer,freetype,harfbuzz,pango
